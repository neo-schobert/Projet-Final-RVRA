...
public class VRCalibration : MonoBehaviour
{
    ...
    private void Calibrate()
    {
        ...
        // ── Étape 1 : Aligner le yaw (ROTATION EN PREMIER) ─────────────────────
        // On tourne l'XR Origin autour de son propre pivot AVANT de translater.
        // Si on translateait d'abord puis tournait, la rotation pivoterait autour
        // du nouvel origine (≠ headset) et déplacerait le headset loin de (0,Y,0).
        ...
        // On relit la position du headset APRÈS la rotation (elle a changé car
        // le headset est enfant du XR Origin qui vient de tourner).
